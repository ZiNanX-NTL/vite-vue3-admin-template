...
const pTexture = await useTexture([
  new URL('@/assets/images/floor/digitalGround1.png', import.meta.url).href,
  new URL('@/assets/images/floor/digitalGround2.png', import.meta.url).href,
  new URL('@/assets/images/floor/digitalGround3.png', import.meta.url).href,
  new URL('@/assets/images/floor/digitalGround4.png', import.meta.url).href
]);
for (let i = 0; i < pTexture.length; i += 1) {
