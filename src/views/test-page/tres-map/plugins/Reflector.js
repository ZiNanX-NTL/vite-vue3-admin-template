...
export class Reflector extends Group {
  constructor({ width = 512, height = 512, clipBias = 0, blurIterations = 8 } = {}) {
    super();
    ...
    this.renderTargetUniform = {
      value: this.blurIterations > 0 ? this.renderTargetRead.texture : this.renderTarget.texture
    };
