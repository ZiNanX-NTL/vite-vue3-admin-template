...
const { themeColor } = defineProps<{
  /** 主题颜色 */
  themeColor: string;
}>();

const lightColor = computed(() => getColorPalette(themeColor, 3));
const darkColor = computed(() => getColorPalette(themeColor, 6));
</script>

<template>
  <div class="size-full absolute-lt z-1 overflow-hidden">
